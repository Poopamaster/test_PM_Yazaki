...
const EditPlanModal = ({ isOpen, onClose, onSave, editFormData, setEditFormData, formatDate }) => {
          ...
          <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div className="form-group" style={{ marginBottom: 0 }}>
              ...
              <input
                ...
                required
                data-date={formatDate(editFormData.planedDate)}
                value={editFormData.planedDate ? editFormData.planedDate.split('T')[0] : ''}
                onChange={(e) => setEditFormData({ ...editFormData, planedDate: e.target.value })}
                style={{ width: '100%', padding: '8px 12px', borderRadius: '6px', border: '1px solid #d1d5db', position: 'relative' }}
              />
            </div>
